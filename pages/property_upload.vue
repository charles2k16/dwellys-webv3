      ...
      <div v-if="step === 1">
        <div class="center">
          <div class="property_upload_head">
            ...
            <small
              >This describes the kind of property you have or want to
              share.</small
            >
          </div>
      ...
      <div v-if="step === 4">
        ...
        <div class="property_content_container pb-20">
          <div class="property_image_uploader">
            ...
            >
              <span class="material-icons" style="color: #cbd5e1"
                >cloud_upload</span
              ><br />
              Drag and drop or browse to choose a file <br />
              <small
                >We advice you use high quality images with proper
                lighting</small
              ></label
            >
          </div>
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      propertySpecs: {
        specifications: [] as Array<any>,
      },
      regions: [] as Array<any>,
      categories: [] as Array<any>,
      amenities: [] as Array<any>,
      pricingPlans: [] as Array<any>,
      countries: [
        {
          code: '+233',
          full_name: 'GHANA',
